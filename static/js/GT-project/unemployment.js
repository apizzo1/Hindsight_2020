...
function buildLinePlot(userDate) {
    ...
    am4core.ready(function () {
        ...
        d3.csv('../static/Resources/UNRATE.csv').then(function (unempData) {
            ...
            if (userDate < 1577836800000) { var moment_date = moment.unix(1577836800).add(1, 'days'); }
            else { var moment_date = moment.unix(userDate / 1000); }

            // format date - pull month only
            var unemp_date = moment_date.add(1, 'days').format('M');
...
// create global variable to hold the slider date
var sliderDate = 1577836800000;
var seriesSetSelect = "..."
...
dateSlider.noUiSlider.on('change', function (values, handle) {
    ...
    // call the build chart function passing in the slider date
